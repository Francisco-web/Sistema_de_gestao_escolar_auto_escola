            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                        <h3><?php echo $dados['nome_usuario']; ?> (<?php echo $dados['tipo']; ?>)
                            <a class="btn btn-default" href="editar_colab.php?id=<?php echo $dados['id_usuario']; ?>&tp=<?php echo $dados['tipo']; ?>"><i class="fa fa-edit"></i></a>
                        </h3>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $dados['ativo']== 1 ? "Ativo " : "Desactivo"; ?>
                                    </div> 
                                </div>
                                <div class="col-md-6">
                                </div>
