        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                        ...
                        <section class="panel">
                            ...
                            if(isset($_SESSION['msg'])){
                             ...
                             if (isset($_GET['id']) && isset($_GET['tp'])) {
                                ...
                                $sql = "SELECT * FROM professor p inner join usuario u on p.id_usuario = u.id_usuario WHERE id_professor = '$id' and tipo = '$tipo' ";
                    ...
                    <div class="row">
                    <input type="hidden" name ="id" value ="<?php echo $dados['id_professor']; ?>">
                    <div class="col-md-6">
