                 ...
                 <!-- /. ROW  -->
                    <hr>
                        <table class="table table-striped table-advance table-hover">
                                ...
                                <?php
                                $contador = 1;
                                $sql = "SELECT * FROM secretaria s inner join usuario u on s.id_usuario = u.id_usuario where tipo = 'Secretaria' order by nome_usuario";
                                ...
                                <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-default" href="deletar_sec.php?id=<?php echo $dados['id_secretaria']; ?>&tp=<?php echo $dados['tipo']; ?>"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
