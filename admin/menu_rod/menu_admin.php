...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioTipo'] !== "Director")) {
...
<head>
    ...
    <title>Area Administrativa - SGE Auto Escola</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php">Auto Escola</a> 
            </div> 
           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="admin.php"><i class="fa fa-home fa-2x"></i> Inicio</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-desktop fa-2x "></i>Gestão Academica<span ></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="registar_nivel.php">Classe</a>
                            </li>
                            <li>
                                <a href="list_disc.php">Disciplina</a>
                            </li>
                            <li>
                                <a href="registar_turma.php">Turma</a>
                            </li>
                            <li>
                                <a href="list_aluno.php">Aluno</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-desktop fa-2x "></i>Gestão Administrativa<span ></span></a>
                        <ul class="nav nav-second-level">
                            
                            <li>
                                <a href="list_usuario.php">Colaborador</a>
                            </li>
                    ...
                    <li>
                        <a  href="list_aval.php"><i class="fa fa-edit fa-2x"></i> Avaliação</a>
                    </li>  
                    <li>
                        <a  href="list_conv.php"><i class="fa fa-copy fa-2x"></i> Comunicado</a>
                    </li>
                    <li>
