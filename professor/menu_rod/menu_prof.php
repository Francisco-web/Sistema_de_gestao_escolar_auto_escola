...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioTipo'] !== "Professor(a)")) {
...
$sql= "SELECT  * FROM professor p inner join usuario u on p.id_usuario = u.id_usuario  where nome_usuario = '$nome' ";
...
<head>
    ...
    <title>Area Docente - SGE Auto Escola</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Professor.php">Auto Escola</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="Professor.php"><i class="fa fa-home fa-3x"></i> Inicio</a>
                    </li>
                    
                    <li>
                        <a href="list_classe.php"><i class="fa fa-users fa-2x "></i> Aluno</a>
                    </li>
