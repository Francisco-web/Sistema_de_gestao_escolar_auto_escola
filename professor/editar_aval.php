                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if (isset($_GET['id'])& isset($_GET['cl'])& isset($_GET['tur']) & isset($_GET['pr'])) {
                          ...
                          ?>
                        <form action="atual_avaliacao.php" method="POST">
                            <div class="row">
                            <input type="hidden" name="id"  class="form-control"  value="<?php echo $dados['id_nota']; ?>"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="p1"  class="form-control"  value="<?php echo $dados['1p']; ?>"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="p2"  class="form-control" value="<?php echo $dados['2p']; ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ac"  class="form-control" value="<?php echo $dados['ac']; ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Exame</label>
                                        <input type="text" name="exame"  class="form-control"value="<?php echo $dados['exame']; ?>"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Recurso</label>
                                        <input type="text" name="recurso"  class="form-control"  value="<?php echo $dados['recurso']; ?>"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="data"  class="form-control"  value="<?php echo $dados['data_emissisao']; ?>" />
                                        
                                    </div>
                                
                                    <button type="submit" name="btn-lancar" class="btn btn-primary"><i class="fa fa-save"></i> Guardar</button> 
